  ...
  async (req: any, res: { send: (arg0: string) => void }) => {
    try {
      ...
      const images = [
        ...
        `./images/elements/${body.element1}.png`,
        `./images/elements/${body.element2}.png`,
      ];
      ...
      const x3 = baseImage.getWidth() - overlayImage3.getWidth() - 300; // X-coordinate for overlayImage3
